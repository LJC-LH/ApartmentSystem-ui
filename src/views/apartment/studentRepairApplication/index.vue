    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['apartment:studentRepairApplication:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
...
<script>
import { listStudentRepairApplication, getStudentRepairApplication, delStudentRepairApplication, addStudentRepairApplication, updateStudentRepairApplication } from "@/api/apartment/studentRepairApplication";
