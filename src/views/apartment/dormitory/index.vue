    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="床位号" prop="roomNo">
        <el-select v-model="queryParams.bedNo" placeholder="请选择床位号">
          <el-option v-for="dict in dict.type.fzu_bed_no" :key="dict.value" :label="dict.label"
            :value="dict.value"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="是否欠费" prop="feesStatus">
        <el-select v-model="queryParams.feesStatus" placeholder="请选择是否欠费" clearable>
          <el-option v-for="dict in dict.type.fzu_fees_status" :key="dict.value" :label="dict.label"
            :value="dict.value" />
        </el-select>
      </el-form-item>
      <el-form-item label="缴费类别" prop="feesCategory">
        <el-select v-model="queryParams.feesCategory" placeholder="请选择缴费类别" clearable>
          <el-option v-for="dict in dict.type.fzu_fees_category" :key="dict.value" :label="dict.label"
            :value="dict.value" />
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="床位使用状态" prop="dormStatus">
        <el-select v-model="queryParams.bedStatus" placeholder="请选择床位使用状态" clearable>
          <el-option v-for="dict in dict.type.fzu_bed_status" :key="dict.value" :label="dict.label" :value="dict.value" />
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['apartment:studentdorm:add']">新增</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button
          type="success"
      ...
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['apartment:studentdorm:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="info" plain icon="el-icon-upload2" size="mini" @click="handleImport"
          v-hasPermi="['apartment:studentdorm:import']">导入</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['apartment:studentdorm:export']">导出</el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
            v-hasPermi="['apartment:studentdorm:edit']">修改</el-button>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="床位使用状态" prop="bedStatus">
          <el-select v-model="form.bedStatus" placeholder="请选择床位使用状态">
            <el-option v-for="dict in dict.type.fzu_bed_status" :key="dict.value" :label="dict.label"
              :value="dict.value"></el-option>
          </el-select>
        </el-form-item>
